...
namespace ScriptInspector.Themes
{
	...
	[InitializeOnLoad]
	public class HermanLight
	{
		private static string _themeName = "Herman Light";
		...
		{
            background              =  new Color32(238,239,230,255),//灰色
			//background				=  new Color32(199,237,204,255),//绿豆沙
			text					=  new Color32(10,10,10,255),
			hyperlinks				= Color.blue,
			
			keywords				= Color.blue,
			constants               = new Color32(10,10,10,200),
			strings					= new Color32(0x80, 0x00, 0x00, 0xff),
			builtInLiterals         = Color.blue,
			operators               = new Color32(10,10,10,200),
			...
			namespaces              = new Color32(10,10,10,200),
			methods                 = new Color32(10,10,10,200),
			fields                  = new Color32(10,10,10,200),
			properties              = new Color32(10,10,10,200),
			events                  = new Color32(10,10,10,200),
			
			parameters              = Color.gray,
			variables               = new Color32(10,10,10,255),
